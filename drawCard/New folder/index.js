...
(function() {
	...
	function main(){
        ...
        clock.style.webkitAnimationPlayState = "running";		
 	  
	    hour.style.display = "block";
		hour.style.animationPlayState = "running";
		hour.style.webkitAnimationPlayState = "running";
	   
	    min.style.display = "block";
		min.style.animationPlayState = "running";
		min.style.webkitAnimationPlayState = "running";
