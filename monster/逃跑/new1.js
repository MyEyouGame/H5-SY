window.requestAnimFrame = (function(){
    ...
    if (game.input.keyboard.isDown(Phaser.KeyCode.DOWN) && this.dragon.downRun === false) {
		 ...
		 var flower3 = document.getElementById("folwer3");			
...
// left gets values from 0px to 400px
	...
	function begin(){
		...
		// mushroom1.style.WebkitAnimationPlayState = "running";
		
		// mushroom2.style.AnimationPlayState = "running";
		// mushroom2.style.WebkitAnimationPlayState = "running";
		
		// flowerLeft.style.animationPlayState = "running";
		// flowerLeft.style.WebkitanimationPlayState = "running";
		
		// flowerRight.style.animationPlayState = "running";
		// flowerRight.style.WebkitanimationPlayState = "running";
