window.requestAnimFrame = (function(){
	...
	function main(){
        ...
        var brick1 = document.getElementsByClassName('brick1') ;		
        var brick2 = document.getElementsByClassName('brick2') ;	
        var brick3 = document.getElementsByClassName('brick3') ;		
        var brick4 = document.getElementsByClassName('brick4') ;		
        var brick5 = document.getElementsByClassName('brick5') ;		
        var brick6 = document.getElementsByClassName('brick6') ;		
        var brick7 = document.getElementsByClassName('brick7') ;		
        var brick8 = document.getElementsByClassName('brick8') ;		
        var brick9 = document.getElementsByClassName('brick9') ;		
        var brick10= document.getElementsByClassName('brick10');		
	...
	function createImage(){
		...
		var GirlRunArray = ['gRun1.png', 
		                    'gRun2.png', 
		                    'gRun3.png'];

        var monsterArray = ['monster1.png',
		                    'monster2.png',
							'monster3.png',
							'monster4.png',
							'monster5.png']
